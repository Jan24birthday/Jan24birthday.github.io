...
$(".button3").on("click", (function(){
    ...
    $(".birthday").append("<p>Hi Janhavi , You have 1 unread important message !  <br/>( Have a special day  <a href='https://jan24birthday.github.io/color%20baloon%20fly%20happy-birthday-animation-main/index.html'> Click here to open </a> )</p>");
    $(".birthday").append("<div class='star'></div>");
